...
function EditorTimeline() {
  return (
    <div className="absolute right-4 bottom-4 left-28 z-10 flex h-64 flex-col rounded-2xl border border-border/50 bg-background/60 shadow-lg ring-1 ring-foreground/5 backdrop-blur-xl backdrop-saturate-150 dark:ring-foreground/10">
