import { listVideoAnimationPresets, type VideoAnimationPresetId } from '@/engine'
import { cn } from '@/lib/utils'

function VideoAnimationPresetPicker({
  value,
  onChange,
}: {
  ...
  const presets = listVideoAnimationPresets()
...
export { VideoAnimationPresetPicker }
